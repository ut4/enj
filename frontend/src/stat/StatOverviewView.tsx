        ...
        return <div class="stats-overview-view">
            { this.state.stats ? <div class="row">
                ...
                <div class="col-8"><div class="box">
                    ...
                    <div>Treeniaika</div>
                    <ul class="striped">
                        <li><span class="score small">{ readableTime(this.state.stats.totalWorkoutTime) }</span><span>(Yhteensä)</span></li>
                        <li><span class="score small">{ readableTime(this.state.stats.averageWorkoutTime) }</span><span>(Keskimäärin)</span></li>
                        <li><span class="score small">{ readableTime(this.state.stats.longestWorkoutTime) }</span><span>(Pisin)</span></li>
                        <li><span class="score small">{ readableTime(this.state.stats.shortestWorkoutTime) }</span><span>(Lyhin)</span></li>
                    </ul>
                </div></div>
            </div> : <p>
                Ei löytynyt mitään.
