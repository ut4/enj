    ...
    public render() {
        return <div class="user-profile-view">
            ...
            { this.state.user && [
                ...
                <Form onConfirm={ () => this.confirm() } confirmButtonShouldBeDisabled={ () => this.state.validity === false } confirmButtonText="Tallenna" cancelButtonText="Takaisin" isModal={ false }>
                    <div>
...
class ProfilePicUpdateModal extends ValidatingComponent<{afterUpload: Function}, {file: File}> {
    ...
    public render() {
        return <div>
            ...
            <Form onConfirm={ () => this.confirm() } confirmButtonShouldBeDisabled={ () => !this.state.validity } closeBehaviour={ CloseBehaviour.IMMEDIATE } isModal={ true }>
                <label class="input-set">
